...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/08 15:54:02 by dbousque          #+#    #+#             */
/*   Updated: 2016/12/08 15:59:01 by dbousque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	complete_command_end(t_client_data *client, int ret,
											...
											int *len, uint32_t cmd_len)
{
	...
	return (complete_command_end(client, ret, tmp_data));
}
