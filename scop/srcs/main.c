...
void	add_environment3(void)
{
	...
	if (!g_conf.generic_textures[3])
		return ;
	load_texture_to_obj(g_conf.generic_textures[3], "environment/plate/diff.jpg");
	load_specular_map_to_obj(g_conf.generic_textures[3], "environment/plate/spec.jpg");
	load_normal_map_to_obj(g_conf.generic_textures[3], "environment/plate/normal.jpg");
...
void	add_environment2(void)
{
	...
	if (!g_conf.generic_textures[2])
		return ;
	load_texture_to_obj(g_conf.generic_textures[2], "environment/parquet2/diff.jpg");
	load_specular_map_to_obj(g_conf.generic_textures[2], "environment/parquet2/spec.jpg");
	load_normal_map_to_obj(g_conf.generic_textures[2], "environment/parquet2/normal.jpg");
...
void	add_environment(t_list *objs)
{
	...
	if (!g_conf.generic_textures[0])
		return ;
	load_texture_to_obj(g_conf.generic_textures[0], "environment/parquet/diff.png");
	load_specular_map_to_obj(g_conf.generic_textures[0], "environment/parquet/spec.png");
	load_normal_map_to_obj(g_conf.generic_textures[0], "environment/parquet/normal.png");
	...
	if (!g_conf.generic_textures[1])
		return ;
	load_texture_to_obj(g_conf.generic_textures[1], "environment/wall2/diff.png");
	load_specular_map_to_obj(g_conf.generic_textures[1], "environment/wall2/spec.png");
	load_normal_map_to_obj(g_conf.generic_textures[1], "environment/wall2/normal.png");
